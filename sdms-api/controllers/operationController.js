...
const checkValidations = require('../validations/operationValidations');
const { getCommonFields } = require('../services/shared/commonFieldService');
const ResponseHandler = require('../utils/responseHandler');

// Instantiate DBCRUDService for operation_master stored procedure
const opsService = new DBCRUDService('sdms_db', 'proc_operation_master_crud');

exports.getById = async (req, res) => {
    const commonFields = getCommonFields(req);
    const data = { id: req.params.id, ...commonFields };
