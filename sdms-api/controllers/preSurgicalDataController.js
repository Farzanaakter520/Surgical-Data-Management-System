// controllers/preSurgicalDataController.js
const DBCRUDService = require('../services/DBCRUDService');
const checkValidations = require('../validations/preSurgicalDataValidations');
const { getCommonFields } = require('../services/shared/commonFieldService');
const ResponseHandler = require('../utils/responseHandler');

const opsService = new DBCRUDService('sdms_db', 'proc_pre_surgical_data_crud');

exports.getById = async (req, res) => {
    const commonFields = getCommonFields(req);
    const data = { ...req.body, ...commonFields };
    try {
        // validation চাইলে চালাও
