// controllers/surgicalDataController.js

const DBCRUDService = require('../services/DBCRUDService');
const checkValidations = require('../validations/surgicalDataValidations');
const { getCommonFields } = require('../services/shared/commonFieldService');
const ResponseHandler = require('../utils/responseHandler');

// Instantiate CRUD Service for surgical data procedure
const opsService = new DBCRUDService('sdms_db', 'proc_surgical_data');
