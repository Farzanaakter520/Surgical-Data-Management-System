// controllers/coMorbiditiesController.js
const DBCRUDService = require('../services/DBCRUDService');
const checkValidations = require('../validations/coMorbiditiesValidations');
const { getCommonFields } = require('../services/shared/commonFieldService');
const ResponseHandler = require('../utils/responseHandler');

// Instantiate service for co-morbidities table
const opsService = new DBCRUDService('sdms_db', 'proc_co_morbidities_crud');
